  ...
  <div>
    <quilleditor ref="myTextEditor"
      ...
      <div id="toolbar" slot="toolbar">
        ...
        <span class="ql-formats"><button class="ql-bold" type="button"></button></span>
        <span class="ql-formats"><button class="ql-italic" type="button"></button></span>
        <span class="ql-formats"><button class="ql-blockquote" type="button"></button></span>
        <span class="ql-formats"><button class="ql-list" type="button" value="ordered"></button></span>
        <span class="ql-formats"><button class="ql-list" type="button" value="bullet"></button></span>
        <span class="ql-formats"><button class="ql-link" type="button"></button></span>
        <span class="ql-formats">
        <button style="outline:none" type="button" @click="imgClick">
        ...
        <span class="ql-formats"><button class="ql-video" type="button"></button></span>
      </div>
    </quilleditor>
  </div>
</template>
