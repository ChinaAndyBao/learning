<template>
  <div>
    ...
    <el-upload v-else ref="singleUpload"
               :http-request="handleUpload"
    ...
    >
      <div @mouseout="showBtn=false" @mouseover="showBtn=true">
        <i v-show="dialogImageUrl && showBtn" class="el-icon-close remove-btn" @click.stop="removeSingle"></i>
        <img v-if="dialogImageUrl" :src="dialogImageUrl" :style="avatarStyle">
        <i v-else :style="avatarStyle" class="el-icon-plus logo-uploader-icon"></i>
      </div>
    </el-upload>
