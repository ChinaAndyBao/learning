<template>
  <div>
    <v-list-tile
        :class="{'selected':isSelected}" :dark="isSelected" class="level1 py-0 my-0" @click="toggle">
      ...
      <v-list-tile-content>
        ...
        <input v-show="beginEdit" :ref="model.id" v-model="model.name" @blur="afterEdit"
               @click.stop="" @keyup.enter="afterEdit"/>
      </v-list-tile-content>
      <v-list-tile-action v-if="isEdit">
        <v-btn :color="c1" icon @mouseout="c1=''" @mouseover="c1='primary'" @click.stop="addChild">
          <i class="el-icon-plus"/>
        </v-btn>
      </v-list-tile-action>
      <v-list-tile-action v-if="isEdit">
        <v-btn :color="c2" icon @mouseout="c2=''" @mouseover="c2='success'" @click.stop="editChild">
          <i class="el-icon-edit"/>
        </v-btn>
      </v-list-tile-action>
      <v-list-tile-action v-if="isEdit">
        <v-btn :color="c3" icon @mouseout="c3=''" @mouseover="c3='error'" @click.stop="deleteChild">
